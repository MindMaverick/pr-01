...
def main():
    ...
    # Lambda function to pass n to fit_function
    try:
    ...
    # Generate the fitted y values using the fitted parameters and including n
    ...
    plt.savefig('decaying_sine_curve_fit.png', dpi=300, bbox_inches='tight')  # Save the plot as a PNG file
    plt.show()
